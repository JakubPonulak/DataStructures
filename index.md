...
<input style="margin-left: 30%; margin-right: 30%; height: 15px" type="text" id="SearchInput" onkeyup="SearchMain(list = websitePages, textcolor = '#c7ffd6', nullcolor = '#e30202', SearchID = 'SearchInput', ResultID = 'SearchResult', DebugMode = false)" placeholder="Search for pages" title="Search for pages">
<br>
<p style="margin-left: 30%; margin-right: 30%; width: 50%" id="SearchResult"></p>
<script>
